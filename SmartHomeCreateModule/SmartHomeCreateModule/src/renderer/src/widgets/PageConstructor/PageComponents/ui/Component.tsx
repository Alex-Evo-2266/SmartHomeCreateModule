...
import { EditComponentDialog } from "../../PageEditDialog"
import { IComponents } from "@renderer/entites/module/models/pageModels/pageModel"
import { CardControlComponent } from "./CardControl/CardControl"
...
export const PageComponent: React.FC<PageComponentProp> = ({data, onEdit, index, onDelete}) => {
    ...
    return(
        ...
        }
        {
            ...
            <CardControlComponent data={data} onClick={showEditDialog}/>:
